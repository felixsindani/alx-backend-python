...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org, mock_org):
        ...
        Args:
            org (str): organisation's name as str
        """
...
def requests_get(*args, **kwargs):
    """
    Function:mocks requests.get function
    Returns correct json data based on the given input url
    """
    class MockResponse:
        """
        Mock response
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def setUpClass(cls):
        """
        mock requests.get to return example payloads found in the fixtures.start a patcher
        """
    ...
    def tearDownClass(cls):
        """
        Stops the patcher that had been started above
        """
